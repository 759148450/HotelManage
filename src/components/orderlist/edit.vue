...
<!--      </el-form-item>-->
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="房间类型" prop="roomTypeId">
          <el-select v-model="ruleForm.roomTypeId" placeholder="请选择" @change="getRole($event)">
...
<!--          <el-input   v-model="ruleForm.currentRoomId"></el-input>-->
          <el-select v-model="ruleForm.currentRoomId" placeholder="请选择" @change="getRole($event)">
          <el-option
            v-for="item in select2"
            :key="item.roomId"
            :label="item.roomId"
